...
a = 1000
b = 1000
print(f"a = {a}, Memory ID: {id(a)}")
print(f"b = {b}, Memory ID: {id(b)}")
print(f"Same memory? {id(a) == id(b)}")
...
print(f"After 8% tax: ${cart_total:.2f}")
...
# Print floor division result and type:
print(f"{dividend} // {divisor} = {floor_div} (type: {type(floor_div).__name__})")

# Print modulo result and type
